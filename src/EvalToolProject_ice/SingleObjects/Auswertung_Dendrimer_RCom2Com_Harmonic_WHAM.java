...
public class Auswertung_Dendrimer_RCom2Com_Harmonic_WHAM {
	...
	public Auswertung_Dendrimer_RCom2Com_Harmonic_WHAM(String fdir, String fname, String dirDst)//, String skip, String current)
	{
	...
	public static void main(String[] args) {
		...
		else new Auswertung_Dendrimer_RCom2Com_Harmonic_WHAM(args[0], args[1], args[2]);//,args[1],args[2]);
