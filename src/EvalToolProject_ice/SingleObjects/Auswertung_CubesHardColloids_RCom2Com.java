...
public class Auswertung_CubesHardColloids_RCom2Com {
	...
	public Auswertung_CubesHardColloids_RCom2Com(String fdir, String fname, String dirDst, double springconstant, double equilibriumlength)//, String skip, String current)
	{
	...
	//	HG_RCom2Com = new Histogramm(0,20.0,80);
		HG_RCom2Com = new Histogramm(+0.125,30.0+0.125,50);
	...
	public static void main(String[] args) {
		...
		else new Auswertung_CubesHardColloids_RCom2Com(args[0], args[1], args[2], Double.parseDouble(args[3]), Double.parseDouble(args[4]));//,args[1],args[2]);
