...
public class Auswertung_Dendrimer_TwoFree_DensityOverlap {
	...
	public Auswertung_Dendrimer_TwoFree_DensityOverlap(String srcdir, String fname, String dstDir)
	{
		FileName =  fname;
		...
		Histo2DSaver_DensityDendrimerOneGnuplot.setzeZeile("set title \"density distribution of 1.st Dendrimer (centered) N = {/Symbol \\362} {/Symbol r}_1 {/Symbol r} d {/Symbol r} d {/Symbol z}\" ");
		...
		Histo2DSaver_DensityDendrimerOneGnuplot.setzeZeile("splot \'"+FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityOne.dat"+"\' matrix using (($1/"+binHistoCounterionsXY+")*"+maxHistoCounterionsXY+"):(0.5*"+HG2D_DensityDendrimerOne.GetIntervallThicknessOfBins2()+"+"+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		...
		Histo2DSaver_DensityDendrimerTwoGnuplot.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityTwo_Gnuplot.gnu", false);
		Histo2DSaver_DensityDendrimerTwoGnuplot.setzeZeile("set term postscript enhanced color");
		Histo2DSaver_DensityDendrimerTwoGnuplot.setzeZeile("set output \'"+FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityTwo.ps"+"\'");
		...
		Histo2DSaver_DensityDendrimerTwoGnuplot.setzeZeile("set title \"density distribution of 2.nd Dendrimer (centered) N = {/Symbol \\362} {/Symbol r}_2 {/Symbol r} d {/Symbol r} d {/Symbol z}\" ");
		...
		Histo2DSaver_DensityDendrimerTwoGnuplot.setzeZeile("splot \'"+FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityTwo.dat"+"\' matrix using (($1/"+binHistoCounterionsXY+")*"+maxHistoCounterionsXY+"):(0.5*"+HG2D_DensityDendrimerTwo.GetIntervallThicknessOfBins2()+"+"+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		...
		Histo2DSaver_DensityDendrimersTotalGnuplot.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityTotal_Gnuplot.gnu", false);
		
		Histo2DSaver_DensityDendrimersTotalGnuplot.setzeZeile("set term postscript enhanced color");
		Histo2DSaver_DensityDendrimersTotalGnuplot.setzeZeile("set output \'"+FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityTotal.ps"+"\'");
		...
		Histo2DSaver_DensityDendrimersTotalGnuplot.setzeZeile("set title \"total density distribution of both dendrimers (centered) 2N = {/Symbol \\362} ({/Symbol r}_1 + {/Symbol r}_2) {/Symbol r} d {/Symbol r} d {/Symbol z}\" ");
		...
		Histo2DSaver_DensityDendrimersTotalGnuplot.setzeZeile("splot \'"+FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityTotal.dat"+"\' matrix using (($1/"+binHistoCounterionsXY+")*"+maxHistoCounterionsXY+"):(0.5*"+HG2D_DensityDendrimersTotal.GetIntervallThicknessOfBins2()+"+"+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
	...
	Histo2DSaver_DensityDendrimerOne.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityOne.dat", false);
	
	for(int z = 0; z < (HG2D_DensityDendrimerOne.GetNrBins2() );z++)
	{
		StringBuffer objectBuffer = new StringBuffer(3000); 
		
		for(int rho = 0; rho < (HG2D_DensityDendrimerOne.GetNrBins1() );rho++)
		{	
			double  Probabilitydensity_HG2D_Rod = numMonosDendrimerOne*HG2D_DensityDendrimerOne.GetNrInBinNormiert(rho,z)/(2.0*Math.PI*HG2D_DensityDendrimerOne.GetRangeInBin1(rho)*HG2D_DensityDendrimerOne.GetIntervallThicknessOfBins1()*HG2D_DensityDendrimerOne.GetIntervallThicknessOfBins2()); 
	...
	Histo2DSaver_DensityDendrimerTwo.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityTwo.dat", false);
	
	for(int z = 0; z < (HG2D_DensityDendrimerTwo.GetNrBins2() );z++)
	{
		StringBuffer objectBuffer = new StringBuffer(3000); 
		
		for(int rho = 0; rho < (HG2D_DensityDendrimerTwo.GetNrBins1() );rho++)
		{	
			double  Probabilitydensity_HG2D_Rod = numMonosDendrimerTwo*HG2D_DensityDendrimerTwo.GetNrInBinNormiert(rho,z)/(2.0*Math.PI*HG2D_DensityDendrimerTwo.GetRangeInBin1(rho)*HG2D_DensityDendrimerTwo.GetIntervallThicknessOfBins1()*HG2D_DensityDendrimerTwo.GetIntervallThicknessOfBins2()); 
	...
	Histo2DSaver_DensityDendrimersTotal.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityTotal.dat", false);
	
	for(int z = 0; z < (HG2D_DensityDendrimersTotal.GetNrBins2() );z++)
		{
			StringBuffer objectBuffer = new StringBuffer(3000); 
			
			for(int rho = 0; rho < (HG2D_DensityDendrimersTotal.GetNrBins1() );rho++)
			{	
				
				//zhl += ((float) HG3D.GetNrInBinNormiert(x,y,z) ) + " ";
				//objectBuffer.append(((float) HG2D_Counterions.GetNrInBinNormiert(rho,z) ) + " ");
				double  Probabilitydensity_HG2D_Counterions = (numMonosDendrimerOne+numMonosDendrimerTwo)*HG2D_DensityDendrimersTotal.GetNrInBinNormiert(rho,z)/(2.0*Math.PI*HG2D_DensityDendrimersTotal.GetRangeInBin1(rho)*HG2D_DensityDendrimersTotal.GetIntervallThicknessOfBins1()*HG2D_DensityDendrimersTotal.GetIntervallThicknessOfBins2()); 
	...
	for(int z = 0; z < (HG2D_OverlapDensityDendrimers.GetNrBins2() );z++)
	{
		...
		{	
			...
			double density_HG2D_DOne = numMonosDendrimerOne*HG2D_DensityDendrimerOne.GetNrInBinNormiert(rho,z)/(2.0*Math.PI*HG2D_DensityDendrimerOne.GetRangeInBin1(rho)*HG2D_DensityDendrimerOne.GetIntervallThicknessOfBins1()*HG2D_DensityDendrimerOne.GetIntervallThicknessOfBins2()); 
			double density_HG2D_DTwo = numMonosDendrimerTwo*HG2D_DensityDendrimerTwo.GetNrInBinNormiert(rho,z)/(2.0*Math.PI*HG2D_DensityDendrimerTwo.GetRangeInBin1(rho)*HG2D_DensityDendrimerTwo.GetIntervallThicknessOfBins1()*HG2D_DensityDendrimerTwo.GetIntervallThicknessOfBins2()); 
	...
	Saver_OverlapIntegral.DateiAnlegen(FileDirectoryDst+"/TwoDendrimers_G7_S1_f3_B64_K1.0_OverlapIntegral.dat", true);
	//Saver_OverlapIntegral.DateiAnlegen(FileDirectoryDst+FileName+"_OverlapIntegral.dat", false);
	Saver_OverlapIntegral.setzeZeile(Rcom2com_Statistik.ReturnM1()+" "+overlapIntegral);
	...
	Histo2DSaver_DensityOverlapDendrimersGnuplot.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityOverlapDendrimers_Gnuplot.gnu", false);
	
	Histo2DSaver_DensityOverlapDendrimersGnuplot.setzeZeile("set term postscript enhanced color");
	Histo2DSaver_DensityOverlapDendrimersGnuplot.setzeZeile("set output \'"+FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityOverlapDendrimers.ps"+"\'");
	...
	Histo2DSaver_DensityOverlapDendrimersGnuplot.setzeZeile("set title \"density overlap distribution of both dendrimers (centered)  N^{2}/V = {/Symbol \\362} ({/Symbol r}_1 {/Symbol \\267} {/Symbol r}_2) {/Symbol r} d {/Symbol r} d {/Symbol z}\" ");
	...
	Histo2DSaver_DensityOverlapDendrimersGnuplot.setzeZeile("splot \'"+FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityOverlapDendrimers.dat"+"\' matrix using (($1/"+binHistoCounterionsXY+")*"+maxHistoCounterionsXY+"):(0.5*"+HG2D_OverlapDensityDendrimers.GetIntervallThicknessOfBins2()+"+"+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
	...
	Histo2DSaver_DensityOverlapDendrimers.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_TwoDendrimers_DensityOverlapDendrimers.dat", false);
	...
	public static void main(String[] args) {
		...
		new Auswertung_Dendrimer_TwoFree_DensityOverlap(args[0], args[1], args[2]);
	}
				...
				*/
				    ...
				    */
					...
					if((distance_New_xy) < maxHistoCounterionsXY )
						if((distance_zNew) < maxHistoCounterionsZ && (distance_zNew) > minHistoCounterionsZ)
							HG2D_DensityDendrimersTotal.AddValue(distance_New_xy,distance_zNew);
					
					if((distance_New_xy) < maxHistoCounterionsXY )
						if((distance_zNew) < maxHistoCounterionsZ && (distance_zNew) > minHistoCounterionsZ)
							HG2D_DensityDendrimerOne.AddValue(distance_New_xy,distance_zNew);
				...
				for(int monoDendrimerTwo = 1; monoDendrimerTwo <= counterCOM_B; monoDendrimerTwo++)
				{
				   ...
				   // System.out.println("xNewTrafo: " + distance_xNew + "   YNewTrafo: " + distance_yNew + "   ZNewTrafo: " + distance_zNew);
					...
					if((distance_New_xy) < maxHistoCounterionsXY )
						if((distance_zNew) < maxHistoCounterionsZ && (distance_zNew) > minHistoCounterionsZ)
							HG2D_DensityDendrimerTwo.AddValue(distance_New_xy,distance_zNew);
