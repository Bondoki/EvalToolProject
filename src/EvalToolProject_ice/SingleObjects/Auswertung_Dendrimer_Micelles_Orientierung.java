...
public class Auswertung_Dendrimer_Micelles_Orientierung {
	...
	public Auswertung_Dendrimer_Micelles_Orientierung(String srcdir, String fname, String dstDir)
	{
...
histo3D_Solvent.DateiSchliessen();
	...
	public static void main(String[] args) {
		...
		System.out.println("Calculation of Density of Counter-ions around HEP-Rod");
		new Auswertung_Dendrimer_Micelles_Orientierung(args[0], args[1], args[2]);
	}
	...
	public void playSimulation(int frame)
	{
				...
				*/
				...
				if((importData.Attributes[HEPCubes] == 4) || (importData.Attributes[HEPCubes] == 5))
				{
					...
					double distance_Z = relDistance_Z;//Math.sqrt(relDistance_Z*relDistance_Z);
