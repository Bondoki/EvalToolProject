...
public class Auswertung_Dendrimer_ZCOM_Rg2_WHAM {
	...
	public Auswertung_Dendrimer_ZCOM_Rg2_WHAM(String fdir, String fname, String dirDst, double _springconstant)//, String skip, String current)
	{
		...
		*/
		...
		//for(int i = 0; i < 21; i++)
		{
			...
			OffSetF[i]=0.0;
			EquLength[i]=0.0+1.0*i;//1.0+2.0*i;//
		...
		*/
		...
		for(int nrHisto = 0; nrHisto < NrOfAllHistogramms; nrHisto++)
		{
			...
			//LoadFile(fname+"L"+(int)(EquLength[nrHisto])+"_NoExVol.bfm",100,nrHisto);
	...
	*/
	...
	protected void LoadFileCorrected(String file, int startframe, int histonr)
	{
		//FileName = file;
		System.out.println("file : " +file );
		System.out.println("dir : " + FileDirectory);
		    ...
		    while ( (z <= NrofFrames))
		      {
		    		...
		    		playSimulationCorrected(z,histonr);
		    		z++;
	...
	public static void main(String[] args) {
		...
		else new Auswertung_Dendrimer_ZCOM_Rg2_WHAM(args[0], args[1], args[2], Double.parseDouble(args[3]));//,args[1],args[2]);
	...
	public void playSimulationCorrected(int frame, int histonr)
	{
				...
				/*
				double correctedRg2_para = Rg2_para*Math.exp( (0.5*springconstant*(ZCom1_z-EquLength[histonr])*(ZCom1_z-EquLength[histonr]) - OffSetF[histonr] - MaximumPotentialBias) );
				double correctedRg2_para_Normalization = Math.exp( (0.5*springconstant*(ZCom1_z-EquLength[histonr])*(ZCom1_z-EquLength[histonr]) - OffSetF[histonr] - MaximumPotentialBias) );

				double correctedRg2_perp = Rg2_perp*Math.exp( (0.5*springconstant*(ZCom1_z-EquLength[histonr])*(ZCom1_z-EquLength[histonr]) - OffSetF[histonr] - MaximumPotentialBias) );
				double correctedRg2_perp_Normalization = Math.exp( (0.5*springconstant*(ZCom1_z-EquLength[histonr])*(ZCom1_z-EquLength[histonr]) - OffSetF[histonr] - MaximumPotentialBias) );

			
				HG_ZCOM_Rg2ParaCorrectedWHAM_StatistikTotal.AddValue(ZCom1_z, correctedRg2_para);
				HG_ZCOM_Rg2ParaCorrectedWHAMNormalization_StatistikTotal.AddValue(ZCom1_z, correctedRg2_para_Normalization);
					
				HG_ZCOM_Rg2PerpCorrectedWHAM_StatistikTotal.AddValue(ZCom1_z, correctedRg2_perp);
				HG_ZCOM_Rg2PerpCorrectedWHAMNormalization_StatistikTotal.AddValue(ZCom1_z, correctedRg2_perp_Normalization);
				*/
				
				 //Paper by Shirts & Chodera also Mitsutake, Sugita, and Okamota
				double correctedRg2_para = Rg2_para*Math.exp( -(0.5*springconstant*(ZCom1_z-EquLength[histonr])*(ZCom1_z-EquLength[histonr])) )/HG_ZCOM_Rg2ParaCorrectedWHAMGeneralNorm_StatistikTotal.GetAverageInBin(HG_ZCOM_Rg2ParaCorrectedWHAMGeneralNorm_StatistikTotal.GetBinOfValue(ZCom1_z));
				double correctedRg2_para_Normalization = Math.exp( -(0.5*springconstant*(ZCom1_z-EquLength[histonr])*(ZCom1_z-EquLength[histonr])) )/HG_ZCOM_Rg2ParaCorrectedWHAMGeneralNorm_StatistikTotal.GetAverageInBin(HG_ZCOM_Rg2ParaCorrectedWHAMGeneralNorm_StatistikTotal.GetBinOfValue(ZCom1_z));

				double correctedRg2_perp = Rg2_perp*Math.exp( -(0.5*springconstant*(ZCom1_z-EquLength[histonr])*(ZCom1_z-EquLength[histonr])) )/HG_ZCOM_Rg2ParaCorrectedWHAMGeneralNorm_StatistikTotal.GetAverageInBin(HG_ZCOM_Rg2ParaCorrectedWHAMGeneralNorm_StatistikTotal.GetBinOfValue(ZCom1_z));
				double correctedRg2_perp_Normalization = Math.exp( -(0.5*springconstant*(ZCom1_z-EquLength[histonr])*(ZCom1_z-EquLength[histonr])) )/HG_ZCOM_Rg2ParaCorrectedWHAMGeneralNorm_StatistikTotal.GetAverageInBin(HG_ZCOM_Rg2ParaCorrectedWHAMGeneralNorm_StatistikTotal.GetBinOfValue(ZCom1_z));
				...
				//HG_ZCOM_Rg2ParaCorrectedProbabilityWHAM_StatistikTotal.AddValue(ZCom1_z, Rg2_para*HG_ZCOM_Statistik[histonr].GetAverageInBin(HG_ZCOM_Statistik[histonr].GetBinOfValue(ZCom1_z)));
				//HG_ZCOM_Rg2PerpCorrectedProbabilityWHAM_StatistikTotal.AddValue(ZCom1_z, Rg2_perp*HG_ZCOM_Statistik[histonr].GetAverageInBin(HG_ZCOM_Statistik[histonr].GetBinOfValue(ZCom1_z)));
	}
