...
public class Auswertung_Arc_Orientierung {
	...
	public Auswertung_Arc_Orientierung(String srcdir, String fname, String dstDir)
	{
		...
		minHistoCounterionsZ=-40.01;//40.2;
		maxHistoCounterionsZ=40.01;//40.2;
...
histo3D_Solvent.DateiSchliessen();
	...
	public static void main(String[] args) {
		...
		System.out.println("Calculation of Density of Counter-ions around HEP-Rod");
		new Auswertung_Arc_Orientierung(args[0], args[1], args[2]);
	}
	...
	public void playSimulation(int frame)
	{
				...
				double ree_z_original  =importData.PolymerKoordinaten[90*(l-1)+ende+3][2]-importData.PolymerKoordinaten[90*(l-1)+start][2];
			           ...
			           ree_z_original /= 4.0;
			      */     
				double ree_x_original  =importData.PolymerKoordinaten[240][0]-importData.PolymerKoordinaten[1][0];
				double ree_y_original  =importData.PolymerKoordinaten[240][1]-importData.PolymerKoordinaten[1][1];
				double ree_z_original  =importData.PolymerKoordinaten[240][2]-importData.PolymerKoordinaten[1][2];
					      
			    double reeOrigin_x_original = importData.PolymerKoordinaten[1][0];
			    
			    double reeOrigin_y_original = importData.PolymerKoordinaten[1][1];
			    	   
			    double reeOrigin_z_original = importData.PolymerKoordinaten[1][2];
				...
				*/
				...
				for(int HEPCubes = 2; HEPCubes <= 239; HEPCubes++)
				{
