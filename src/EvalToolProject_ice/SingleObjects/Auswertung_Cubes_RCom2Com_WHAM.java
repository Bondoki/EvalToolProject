...
public class Auswertung_Cubes_RCom2Com_WHAM {
	...
	public Auswertung_Cubes_RCom2Com_WHAM(String fdir, String fname, String dirDst, double springconstant)//, String skip, String current)
	{
		...
		*/
		...
		for(int i = 0; i < NrOfAllHistogramms; i++)
		{
			...
			HG_RCom2Com_Plain[i] = new Histogramm(+0.125,20.0+0.125,640);
			HG_RCom2Com_Statistik[i] = new HistogrammStatistik(+0.125,20.0+0.125,640);
			OffSetF[i]=0.0;
			EquLength[i]=3.0+0.5*i;
			System.out.println("EquLength["+i+"]: " + EquLength[i]);
		}
		
		HG_RCom2Com_StatistikTotal = new HistogrammStatistik(+0.125,20.0+0.125,640);
	...
	public static void main(String[] args) {
		...
		else new Auswertung_Cubes_RCom2Com_WHAM(args[0], args[1], args[2], Double.parseDouble(args[3]));//,args[1],args[2]);
