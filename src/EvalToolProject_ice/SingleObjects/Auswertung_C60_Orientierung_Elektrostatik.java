...
public class Auswertung_C60_Orientierung_Elektrostatik {
	...
	public Auswertung_C60_Orientierung_Elektrostatik(String srcdir, String fname, String dstDir)
	{
		...
		{
			histo_ree.setzeZeile(HG_ree.GetRangeInBin(i)+" "+HG_ree.GetNrInBinNormiert(i)/(HG_ree.GetRangeInBin(i)*HG_ree.GetRangeInBin(i)*HG_ree.GetIntervallThickness()) +" " +HG_ree.GetNrOfCounts());
		...
		{
			histo_Distance_Counterions.setzeZeile(HG_Distance_Counterions.GetRangeInBin(i)+" "+HG_Distance_Counterions.GetNrInBinNormiert(i) +" "+HG_Distance_Counterions.GetNrOfCounts());
	...
	public void playSimulation(int frame)
	{
			    ...
			    System.out.println("xcom: " + reeOrigin_x_cm + "   ycom: " + reeOrigin_y_cm + "   zcom: " + reeOrigin_z_cm );
			 ...
			 /*   {
				...
				for(int counterions = 1; counterions <= 60; counterions++)
				{
					...
					*/
					...
					double distance = Math.sqrt(relDistance_X*relDistance_X + relDistance_Y*relDistance_Y);
					//double distance = Math.sqrt(relDistance_Z*relDistance_Z+relDistance_X*relDistance_X + relDistance_Y*relDistance_Y);
