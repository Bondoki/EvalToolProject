...
public class Auswertung_Dendrimer_Helmet_Orientierung {
	...
	public Auswertung_Dendrimer_Helmet_Orientierung(String srcdir, String fname, String dstDir, int _startframe)
	{
		...
		minHistoCounterionsXY=-25.01*2;//40.01;
		maxHistoCounterionsXY=25.01*2;//40.01;
		int binHistoCounterionsXY = 40*2;
		
		minHistoCounterionsZ=-12.01*2*2;//40.2;
		maxHistoCounterionsZ=12.01*2*2;//40.2;
		int binHistoCounterionsZ = 25*4;
		...
		histo3D.DateiAnlegen(FileDirectoryDst+FileName+"_Histo3D_Dendrimer.vtk", false);
		...
		histo3D_Counterions.DateiAnlegen(FileDirectoryDst+FileName+"_Histo3D_LinearExterior.vtk", false);
		histo_Distance_Counterions.DateiAnlegen(FileDirectoryDst+FileName+"_Histo_Distance_LinearExterior.dat", false);
		
		
		histo2D_Counterions.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_LinearExterior.dat", false);
		histo2D_CounterionsNormiert.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_LinearExteriorNormiert.dat", false);
		histo2D_CounterionsGnuplot.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_LinearExteriorGnuplot.gnu", false);
		
		histo2D_CounterionsGnuplot.setzeZeile("set term postscript enhanced color");
		histo2D_CounterionsGnuplot.setzeZeile("set output \'"+FileDirectoryDst+FileName+"_Histo2D_LinearExteriorNormiert.ps"+"\'");
		...
		histo2D_CounterionsGnuplot.setzeZeile("set title \"density distribution of LinearExterior (normalized)\" ");
		histo2D_CounterionsGnuplot.setzeZeile("unset key");
		histo2D_CounterionsGnuplot.setzeZeile("# set size square");
		histo2D_CounterionsGnuplot.setzeZeile("set size ratio -1");
		...
		histo2D_CounterionsGnuplot.setzeZeile("#set palette rgbformulae 30,31,32;  set palette negative");
		histo2D_CounterionsGnuplot.setzeZeile("# HOT");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette rgbformulae 21,22,23;  set palette negative");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette defined ( 0 '#FFFFFF', 1 '#FFFFD9',  2 '#EDF8B1', 3 '#C7E9B4', 4 '#7FCDBB', 5 '#41B6C4', 6 '#1D91C0', 7 '#225EA8', 8 '#0C2C84')");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette defined ( 0 '#FFFFFF',  1 '#FFF7FB',  2 '#ECE7F2', 3 '#D0D1E6', 4 '#A6BDDB', 5 '#74A9CF', 6 '#3690C0', 7 '#0570B0', 8 '#034E7B' )");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette defined ( 0 '#ffffff', 1 '#ffee00', 2 '#ff7000', 3 '#ee0000', 4 '#7f0000')");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette defined ( 0 '#ffffff', 1 '#f7fbff', 2 '#deebf7', 3 '#c6dbef', 4 '#9ecae1', 5 '#6baed6', 6 '#4292c6', 7 '#2171b5', 8 '#08519c', 9 '#08306b')");
		histo2D_CounterionsGnuplot.setzeZeile("# OCEAN");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette rgbformulae 23, 28, 3; set palette negative");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette defined ( 0 '#FFFFFF', 1 '#F7FCFD', 2 '#E0ECF4', 3 '#BFD3E6', 4 '#9EBCDA', 5 '#8C96C6', 6 '#8C6BB1', 7 '#88419D', 8'#6E016B' )");
		histo2D_CounterionsGnuplot.setzeZeile("# Blues");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette defined ( 0 '#084594', 1 '#2171B5', 2 '#4292C6', 3 '#6BAED6', 4 '#9ECAE1', 5 '#C6DBEF', 6 '#DEEBF7', 7 '#F7FBFF', 8 '#FFFFFF'); set palette negative");
		histo2D_CounterionsGnuplot.setzeZeile("# Reds");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette defined ( 0 '#FFFFFF', 1 '#FFF5F0', 2 '#FEE0D2', 3 '#FCBBA1', 4 '#FC9272', 5 '#FB6A4A', 6 '#EF3B2C', 7 '#CB181D', 8'#99000D' )");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette cubehelix start 0.5 cycles -1.5 saturation 1; set palette gamma 1.5; set palette negative");
		histo2D_CounterionsGnuplot.setzeZeile("set palette defined ( 0 '#FFFFFF', 1 '#FFFFD9',  2 '#EDF8B1', 3 '#C7E9B4', 4 '#7FCDBB', 5 '#41B6C4', 6 '#1D91C0', 7 '#225EA8', 8 '#0C2C84')");
		histo2D_CounterionsGnuplot.setzeZeile("#set palette rgbformulae 34,35,36;  set palette negative");

		histo2D_CounterionsGnuplot.setzeZeile("#load 'viridis.pal'; set palette negative");
		histo2D_CounterionsGnuplot.setzeZeile("#load 'magma.pal'; set palette negative");
		histo2D_CounterionsGnuplot.setzeZeile("#load 'inferno.pal'; set palette negative");
		histo2D_CounterionsGnuplot.setzeZeile("#load 'plasma.pal'; set palette negative");
		histo2D_CounterionsGnuplot.setzeZeile("#load 'cividis.pal'; set palette negative");
		
		histo2D_CounterionsGnuplot.setzeZeile("#splot \'"+FileDirectoryDst+FileName+"_Histo2D_LinearExterior.dat"+"\' matrix using (($1/"+binHistoCounterionsXY+")*"+maxHistoCounterionsXY+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		histo2D_CounterionsGnuplot.setzeZeile("splot \'"+FileDirectoryDst+FileName+"_Histo2D_LinearExteriorNormiert.dat"+"\' matrix using (($1/"+binHistoCounterionsXY+")*"+maxHistoCounterionsXY+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		...
		histo2D_RodGnuplot.setzeZeile("set output \'"+FileDirectoryDst+FileName+"_Histo2D_DendrimerNormiert.ps"+"\'");
		...
		histo2D_RodGnuplot.setzeZeile("set title \"density distribution of Dendrimer (normalized)\" ");
		histo2D_RodGnuplot.setzeZeile("unset key");
		histo2D_RodGnuplot.setzeZeile("#set size square");
		histo2D_RodGnuplot.setzeZeile("set size ratio -1");
		...
		histo2D_RodGnuplot.setzeZeile("#set palette rgbformulae 30,31,32;  set palette negative");
		histo2D_RodGnuplot.setzeZeile("# HOT");
		histo2D_RodGnuplot.setzeZeile("#set palette rgbformulae 21,22,23;  set palette negative");
		histo2D_RodGnuplot.setzeZeile("#set palette defined ( 0 '#FFFFFF', 1 '#FFFFD9',  2 '#EDF8B1', 3 '#C7E9B4', 4 '#7FCDBB', 5 '#41B6C4', 6 '#1D91C0', 7 '#225EA8', 8 '#0C2C84')");
		histo2D_RodGnuplot.setzeZeile("#set palette defined ( 0 '#FFFFFF',  1 '#FFF7FB',  2 '#ECE7F2', 3 '#D0D1E6', 4 '#A6BDDB', 5 '#74A9CF', 6 '#3690C0', 7 '#0570B0', 8 '#034E7B' )");
		histo2D_RodGnuplot.setzeZeile("#set palette defined ( 0 '#ffffff', 1 '#ffee00', 2 '#ff7000', 3 '#ee0000', 4 '#7f0000')");
		histo2D_RodGnuplot.setzeZeile("#set palette defined ( 0 '#ffffff', 1 '#f7fbff', 2 '#deebf7', 3 '#c6dbef', 4 '#9ecae1', 5 '#6baed6', 6 '#4292c6', 7 '#2171b5', 8 '#08519c', 9 '#08306b')");
		histo2D_RodGnuplot.setzeZeile("# OCEAN");
		histo2D_RodGnuplot.setzeZeile("#set palette rgbformulae 23, 28, 3; set palette negative");
		histo2D_RodGnuplot.setzeZeile("#set palette defined ( 0 '#FFFFFF', 1 '#F7FCFD', 2 '#E0ECF4', 3 '#BFD3E6', 4 '#9EBCDA', 5 '#8C96C6', 6 '#8C6BB1', 7 '#88419D', 8'#6E016B' )");
		histo2D_RodGnuplot.setzeZeile("# Blues");
		histo2D_RodGnuplot.setzeZeile("#set palette defined ( 0 '#084594', 1 '#2171B5', 2 '#4292C6', 3 '#6BAED6', 4 '#9ECAE1', 5 '#C6DBEF', 6 '#DEEBF7', 7 '#F7FBFF', 8 '#FFFFFF'); set palette negative");
		histo2D_RodGnuplot.setzeZeile("# Reds");
		histo2D_RodGnuplot.setzeZeile("#set palette defined ( 0 '#FFFFFF', 1 '#FFF5F0', 2 '#FEE0D2', 3 '#FCBBA1', 4 '#FC9272', 5 '#FB6A4A', 6 '#EF3B2C', 7 '#CB181D', 8'#99000D' )");
		histo2D_RodGnuplot.setzeZeile("#set palette cubehelix start 0.5 cycles -1.5 saturation 1; set palette gamma 1.5; set palette negative");
		histo2D_RodGnuplot.setzeZeile("#set palette defined ( 0 '#FFFFFF', 1 '#FFFFD9',  2 '#EDF8B1', 3 '#C7E9B4', 4 '#7FCDBB', 5 '#41B6C4', 6 '#1D91C0', 7 '#225EA8', 8 '#0C2C84')");
		histo2D_RodGnuplot.setzeZeile("set palette rgbformulae 34,35,36;  set palette negative");

		histo2D_RodGnuplot.setzeZeile("#load 'viridis.pal'; set palette negative");
		histo2D_RodGnuplot.setzeZeile("#load 'magma.pal'; set palette negative");
		histo2D_RodGnuplot.setzeZeile("#load 'inferno.pal'; set palette negative");
		histo2D_RodGnuplot.setzeZeile("#load 'plasma.pal'; set palette negative");
		histo2D_RodGnuplot.setzeZeile("#load 'cividis.pal'; set palette negative");
		histo2D_RodGnuplot.setzeZeile("#splot \'"+FileDirectoryDst+FileName+"_Histo2D_Dendrimer.dat"+"\' matrix using (($1/"+binHistoCounterionsXY+")*"+maxHistoCounterionsXY+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		histo2D_RodGnuplot.setzeZeile("splot \'"+FileDirectoryDst+FileName+"_Histo2D_DendrimerNormiert.dat"+"\' matrix using (($1/"+binHistoCounterionsXY+")*"+maxHistoCounterionsXY+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		histo2D_RodGnuplot.setzeLeerzeile();
		histo2D_RodGnuplot.DateiSchliessen();

		
		histo2D_RodHalf.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_DendrimerHalf.dat", false);
		histo2D_RodHalfNormiert.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_DendrimerHalfNormiert.dat", false);
		histo2D_RodHalfGnuplot.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_DendrimerHalfGnuplot.gnu", false);
		
		histo2D_RodHalfGnuplot.setzeZeile("set term postscript enhanced color");
		histo2D_RodHalfGnuplot.setzeZeile("set output \'"+FileDirectoryDst+FileName+"_Histo2D_DendrimerHalfNormiert.ps"+"\'");
		...
		histo2D_RodHalfGnuplot.setzeZeile("set title \"density distribution of Dendrimer (halfspace\\\\&normalized)\" ");
		...
		histo2D_RodHalfGnuplot.setzeZeile("#splot \'"+FileDirectoryDst+FileName+"_Histo2D_DendrimerHalf.dat"+"\' matrix using ("+minHistoCounterionsXY+"+($1/"+2*binHistoCounterionsXY+")*"+(maxHistoCounterionsXY-minHistoCounterionsXY)+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		histo2D_RodHalfGnuplot.setzeZeile("splot \'"+FileDirectoryDst+FileName+"_Histo2D_DendrimerHalfNormiert.dat"+"\' matrix using ("+minHistoCounterionsXY+"+($1/"+2*binHistoCounterionsXY+")*"+(maxHistoCounterionsXY-minHistoCounterionsXY)+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		histo2D_RodHalfGnuplot.setzeLeerzeile();
		histo2D_RodHalfGnuplot.DateiSchliessen();

		histo2D_CounterionsHalf.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_LinearExteriorHalf.dat", false);
		histo2D_CounterionsHalfNormiert.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_LinearExteriorHalfNormiert.dat", false);
		histo2D_CounterionsHalfGnuplot.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_LinearExteriorHalfGnuplot.gnu", false);

		histo2D_CounterionsHalfGnuplot.setzeZeile("set term postscript enhanced color");
		histo2D_CounterionsHalfGnuplot.setzeZeile("set output \'"+FileDirectoryDst+FileName+"_Histo2D_LinearExteriorHalfNormiert.ps"+"\'");
		...
		histo2D_CounterionsHalfGnuplot.setzeZeile("set title \"density distribution of LinearExterior (halfspace\\\\&normalized)\" ");
		...
		histo2D_CounterionsHalfGnuplot.setzeZeile("#splot \'"+FileDirectoryDst+FileName+"_Histo2D_LinearExteriorHalf.dat"+"\' matrix using ("+minHistoCounterionsXY+"+($1/"+2*binHistoCounterionsXY+")*"+(maxHistoCounterionsXY-minHistoCounterionsXY)+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		histo2D_CounterionsHalfGnuplot.setzeZeile("splot \'"+FileDirectoryDst+FileName+"_Histo2D_LinearExteriorHalfNormiert.dat"+"\' matrix using ("+minHistoCounterionsXY+"+($1/"+2*binHistoCounterionsXY+")*"+(maxHistoCounterionsXY-minHistoCounterionsXY)+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		histo2D_CounterionsHalfGnuplot.setzeLeerzeile();
		histo2D_CounterionsHalfGnuplot.DateiSchliessen();

		histo3D_Solvent.DateiAnlegen(FileDirectoryDst+FileName+"_Histo3D_CoDendrimer.vtk", false);
		
		histo2D_Solvent.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_CoDendrimer.dat", false);
		histo2D_SolventNormiert.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_CoDendrimerNormiert.dat", false);
		histo2D_SolventGnuplot.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_CoDendrimerGnuplot.gnu", false);
		
		histo2D_SolventGnuplot.setzeZeile("set term postscript enhanced color");
		histo2D_SolventGnuplot.setzeZeile("set output \'"+FileDirectoryDst+FileName+"_Histo2D_CoDendrimerNormiert.ps"+"\'");
		...
		histo2D_SolventGnuplot.setzeZeile("set title \"density distribution of CoDendrimer (normalized)\" ");
		histo2D_SolventGnuplot.setzeZeile("unset key");
		histo2D_SolventGnuplot.setzeZeile("# set size square");
		histo2D_SolventGnuplot.setzeZeile("set size ratio -1");
		...
		histo2D_SolventGnuplot.setzeZeile("#splot \'"+FileDirectoryDst+FileName+"_Histo2D_CoDendrimer.dat"+"\' matrix using (($1/"+binHistoCounterionsXY+")*"+maxHistoCounterionsXY+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		histo2D_SolventGnuplot.setzeZeile("splot \'"+FileDirectoryDst+FileName+"_Histo2D_CoDendrimerNormiert.dat"+"\' matrix using (($1/"+binHistoCounterionsXY+")*"+maxHistoCounterionsXY+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		histo2D_SolventGnuplot.setzeLeerzeile();
		histo2D_SolventGnuplot.DateiSchliessen();
	
		histo2D_SolventHalf.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_CoDendrimerHalf.dat", false);
		histo2D_SolventHalfNormiert.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_CoDendrimerHalfNormiert.dat", false);
		histo2D_SolventHalfGnuplot.DateiAnlegen(FileDirectoryDst+FileName+"_Histo2D_CoDendrimerHalfGnuplot.gnu", false);

		histo2D_SolventHalfGnuplot.setzeZeile("set term postscript enhanced color");
		histo2D_SolventHalfGnuplot.setzeZeile("set output \'"+FileDirectoryDst+FileName+"_Histo2D_CoDendrimerHalfNormiert.ps"+"\'");
		...
		histo2D_SolventHalfGnuplot.setzeZeile("set title \"density distribution of CoDendrimer (halfspace\\\\&normalized)\" ");
		...
		histo2D_SolventHalfGnuplot.setzeZeile("#splot \'"+FileDirectoryDst+FileName+"_Histo2D_CoDendrimerHalf.dat"+"\' matrix using ("+minHistoCounterionsXY+"+($1/"+2*binHistoCounterionsXY+")*"+(maxHistoCounterionsXY-minHistoCounterionsXY)+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		histo2D_SolventHalfGnuplot.setzeZeile("splot \'"+FileDirectoryDst+FileName+"_Histo2D_CoDendrimerHalfNormiert.dat"+"\' matrix using ("+minHistoCounterionsXY+"+($1/"+2*binHistoCounterionsXY+")*"+(maxHistoCounterionsXY-minHistoCounterionsXY)+"):("+minHistoCounterionsZ+"+($2/"+binHistoCounterionsZ+")*"+(maxHistoCounterionsZ-minHistoCounterionsZ)+"):3 ");
		...
		LoadFile(FileName+".bfm", _startframe);
		...
		histo3D.setzeZeile("Histogram orientation along COM2COM of dendritic part");
		...
		histo3D_Counterions.setzeZeile("Histogram orientation along COM2COM of linear exterior");
	...
	for(int z = 0; z < (HG2D_Rod.GetNrBins2() );z++)
	{
		...
		{	
			double  Probabilitydensity_HG2D_Rod = HG2D_Rod.GetNrInBinNormiert(rho,z     )/(2.0*Math.PI*HG2D_Rod.GetRangeInBin1(rho)*HG2D_Rod.GetIntervallThicknessOfBins1()*HG2D_Rod.GetIntervallThicknessOfBins2()); 
			testDichte += Probabilitydensity_HG2D_Rod * 2.0*Math.PI*HG2D_Rod.GetRangeInBin1(rho)*HG2D_Rod.GetIntervallThicknessOfBins1()*HG2D_Rod.GetIntervallThicknessOfBins2();
		}
	}

	System.out.println("Integral DichteHG2D_Rod(rho,z) : " +testDichte );
...
histo3D_Solvent.setzeZeile("Histogram orientation along COM2COM of total Codendrimer");
...
histo3D_Solvent.DateiSchliessen();
	...
	public static void main(String[] args) {
		...
		if(args.length != 4)
		{
			System.out.println("Calculation of Density of CoDendrimer");
			System.out.println("HEP-Rod will be Oriented in ez Direction");
			System.out.println("USAGE: SrcDir/ FileName[.bfm] DstDir/ StartFrame");
			System.exit(1);
		}
		System.out.println("Calculation of Density of Counter-ions around HEP-Rod");
		new Auswertung_Dendrimer_Helmet_Orientierung(args[0], args[1], args[2], Integer.parseInt(args[3]));
	}
	...
	public void playSimulation(int frame)
	{
				...
				double rcm_Linear_x=0;
				double rcm_Linear_y=0;
				double rcm_Linear_z=0;
				
				long counterCOM1 =0;
				
				for(int j=1; j <= importData.NrOfMonomers; j++)
				{
					//if((importData.Attributes[j]==1) || (importData.Attributes[j]==4))
					if((importData.Attributes[j]==4) || (importData.Attributes[j]==5))
					{
					rcm_Linear_x += importData.PolymerKoordinaten[j][0];
					rcm_Linear_y += importData.PolymerKoordinaten[j][1];
					rcm_Linear_z += importData.PolymerKoordinaten[j][2];
					
					counterCOM1++;
					}
				}
				
				rcm_Linear_x /= (1.0*counterCOM1);
				rcm_Linear_y /= (1.0*counterCOM1);
				rcm_Linear_z /= (1.0*counterCOM1);
				
				System.out.println("used monomers: " +counterCOM1);
				
				double rcm_Dendrimer_x=0;
				double rcm_Dendrimer_y=0;
				double rcm_Dendrimer_z=0;
				
				long counterCOM2 =0;
				
				for(int j=1; j <= importData.NrOfMonomers; j++)
				{
					//if((importData.Attributes[j]==2) || (importData.Attributes[j]==5))
					if((importData.Attributes[j]==1) || (importData.Attributes[j]==2))
					{
					rcm_Dendrimer_x += importData.PolymerKoordinaten[j][0];
					rcm_Dendrimer_y += importData.PolymerKoordinaten[j][1];
					rcm_Dendrimer_z += importData.PolymerKoordinaten[j][2];
					
					counterCOM2++;
					}
				}
				
				rcm_Dendrimer_x /= (1.0*counterCOM2);
				rcm_Dendrimer_y /= (1.0*counterCOM2);
				rcm_Dendrimer_z /= (1.0*counterCOM2);
				
				System.out.println("used monomers: " +counterCOM2);
				...
				*/
				...
				double ree_z_original  =importData.PolymerKoordinaten[90*(l-1)+ende+3][2]-importData.PolymerKoordinaten[90*(l-1)+start][2];
			           ...
			           ree_z_original /= 4.0;
			      */     
				double ree_x_original  = rcm_Linear_x-rcm_Dendrimer_x;// importData.PolymerKoordinaten[20][0]-importData.PolymerKoordinaten[20][0];
				double ree_y_original  = rcm_Linear_y-rcm_Dendrimer_y;//importData.PolymerKoordinaten[20][1]+1-importData.PolymerKoordinaten[20][1];
				double ree_z_original  = rcm_Linear_z-rcm_Dendrimer_z;//importData.PolymerKoordinaten[20][2]+10-importData.PolymerKoordinaten[20][2];
					      
			    double reeOrigin_x_original = rcm_Dendrimer_x;// importData.PolymerKoordinaten[20][0];
			    
			    double reeOrigin_y_original = rcm_Dendrimer_y;// importData.PolymerKoordinaten[20][1];
			    	   
			    double reeOrigin_z_original = rcm_Dendrimer_z;// importData.PolymerKoordinaten[20][2];
				...
				*/
				...
				//if((importData.Attributes[HEPCubes] == 2) || (importData.Attributes[HEPCubes] == 5))
				if((importData.Attributes[HEPCubes] == 1) || (importData.Attributes[HEPCubes] == 2))
				{
					...
					//int co_X = ((importData.PolymerKoordinaten[HEPCubes][0]%Lattice_x)+Lattice_x)%Lattice_x;
					//int co_Y = ((importData.PolymerKoordinaten[HEPCubes][1]%Lattice_y)+Lattice_y)%Lattice_y;
					//int co_Z = ((importData.PolymerKoordinaten[HEPCubes][2]%Lattice_z)+Lattice_z)%Lattice_z;
				    ...
				    System.out.println("Ree: " + (zNew) + "   distance_zNew = 0: " + distance_zNew );
				    ...
				    */
				    ...
				    System.out.println("LambdaPoint: " + LambdaPoint + "         distance_zNew:"+distance_zNew);
					...
					/*if((distance_New_xy) < maxHistoCounterionsXY )
						if((distance_zNew) < maxHistoCounterionsZ && (distance_zNew) > minHistoCounterionsZ)
							{
								double vecX = importData.PolymerKoordinaten[43][0]-importData.PolymerKoordinaten[20][0];
								double vecY = importData.PolymerKoordinaten[43][1]-importData.PolymerKoordinaten[20][1];
								double vecZ = importData.PolymerKoordinaten[43][2]-importData.PolymerKoordinaten[20][2];
								
								double vecX2 = importData.PolymerKoordinaten[HEPCubes][0]-importData.PolymerKoordinaten[20][0];
								double vecY2 = importData.PolymerKoordinaten[HEPCubes][1]-importData.PolymerKoordinaten[20][1];
								double vecZ2 = importData.PolymerKoordinaten[HEPCubes][2]-importData.PolymerKoordinaten[20][2];
								
								double scalar = vecX*vecX2 + vecY*vecY2 + vecZ*vecZ2;
								
								if (scalar >0)
									{
										HG2D_RodHalf.AddValue(distance_New_xy,distance_zNew);
				...
				int offset = 0;//90*NrOfHeparin+(4*NrOfMonomersPerStarArm+1)*NrOfStars;
				
				//distribution of Linear-cubes
				for(int counterions = 1; counterions <= importData.NrOfMonomers; counterions++)
				//if((importData.Attributes[counterions] == 1) || (importData.Attributes[counterions] == 4))
				if((importData.Attributes[counterions] == 4) || (importData.Attributes[counterions] == 5))
				{
					//return ( ((x1-x2) < LATTICE_HALF_NEGATIV) ? (x1-x2+LATTICE) : ( ((x1-x2) > LATTICE_HALF) ? (x1-x2-LATTICE) : (x1-x2) ) );
						...
						if((distance_zNew) < maxHistoCounterionsZ && (distance_zNew) > minHistoCounterionsZ)
							{
								...
								double vecX2 = importData.PolymerKoordinaten[offset+counterions][0]-importData.PolymerKoordinaten[20][0];
								double vecY2 = importData.PolymerKoordinaten[offset+counterions][1]-importData.PolymerKoordinaten[20][1];
								double vecZ2 = importData.PolymerKoordinaten[offset+counterions][2]-importData.PolymerKoordinaten[20][2];
				...
				for(int solvent = 1; solvent <= importData.NrOfMonomers; solvent++)
				{
					//return ( ((x1-x2) < LATTICE_HALF_NEGATIV) ? (x1-x2+LATTICE) : ( ((x1-x2) > LATTICE_HALF) ? (x1-x2-LATTICE) : (x1-x2) ) );
