...
public class Auswertung_Sterne_Gyro_HepPEG_MSDStars {
	...
	public Auswertung_Sterne_Gyro_HepPEG_MSDStars(String fdir, String fname, String dstdir)//, String skip, String current)
	{
		...
		rg = new BFMFileSaver();
		rg.DateiAnlegen(dstdir+"MSD_"+FileName+".dat", false);
		...
		LoadFile(FileName+".ice", currentFrame);
	...
	public static void main(String[] args) {
		...
		new Auswertung_Sterne_Gyro_HepPEG_MSDStars(args[0], args[1], args[2]);//,args[1],args[2]);
	}
