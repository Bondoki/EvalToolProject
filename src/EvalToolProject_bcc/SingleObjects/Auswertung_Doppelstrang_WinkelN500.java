...
public class Auswertung_Doppelstrang_WinkelN500 {
	...
	public Auswertung_Doppelstrang_WinkelN500()
	{
		...
		//System.out.println("cf="+currentFrame);
		 ...
		 MonoProStrang=500;//250;
		 //String Name = "DoppelstrangA250_fest";
		 Name = "DoppelstrangA500MSD";
		...
		/*WinkelStat = new Statistik[MonoProStrang+1];
		 ...
		 Twist_StatElementKette1= new Statistik[49900];
		 	for (int i = 0; i < 49900; i++)
		 		Twist_StatElementKette1[i] = new Statistik();

		 Twist_StatElementKette2= new Statistik[49900];
		 	for (int i = 0; i < 49900; i++)
		...
		saveTwistElementKette1.DateiAnlegen("/home/users/dockhorn/MessungDiplom/octave/AusgewertetN500/"+Name+"_WindungElementKette1.dat",false);
		saveTwistElementKette2.DateiAnlegen("/home/users/dockhorn/MessungDiplom/octave/AusgewertetN500/"+Name+"_WindungElementKette2.dat",false);
	...
	public static void main(String[] args) {
		...
		new Auswertung_Doppelstrang_WinkelN500();
	}
	...
	public void playSimulation(int frame)
	{
				...
				*/
				 ...
				 */
				System.out.println("N500 frame" + frame);
				
				//if(frame <= 20)
				{
				 savePunkte.DateiAnlegen("/home/users/dockhorn/MessungDiplom/octave/AusgewertetN500/"+Name+"_Punkte.dat",false);
					...
					savePunkte.setzeZeile("# rows: 500");
					...
					for(int i = 1; i <= MonoProStrang;i++)
					 ...
					 try {
					      Runtime.getRuntime().exec("octave /home/users/dockhorn/MessungDiplom/octave/AusgewertetN500/AuswertungTwistN500_Kette1.m").waitFor();
					     Thread.sleep(25);
					      Runtime.getRuntime().exec("octave /home/users/dockhorn/MessungDiplom/octave/AusgewertetN500/AuswertungTwistN500_Kette2.m").waitFor();
					      Thread.sleep(25);
					      //Runtime.getRuntime().
					 } catch (Exception e) {
					 ...
					 loader01.DateiOeffnen("/home/users/dockhorn/MessungDiplom/octave/AusgewertetN500/AuswertungTwistN500_StatKette1ElementTorsionKette1.dat");
					 ...
					 loader02.DateiOeffnen("/home/users/dockhorn/MessungDiplom/octave/AusgewertetN500/AuswertungTwistN500_StatKette1ElementTorsionKette2.dat");
