...
public class Auswertung_TrennungDNA_Rc2c_G {
	...
	public Auswertung_TrennungDNA_Rc2c_G(String fdir, String fname, String dirDst, int nrOfFiles)//, String skip, String current)
	{
		...
		if(maxframe == 0)
		{
			System.err.println("maxFrame: "+ maxframe);
			System.exit(1);
		}
		if(deltaT == 0)
		{
			System.err.println("dT: "+ deltaT);
			System.exit(1);
		}
	...
	public static void main(String[] args) {
		...
		else new Auswertung_TrennungDNA_Rc2c_G(args[0], args[1], args[2] , Integer.parseInt(args[3]));//,args[1],args[2]);
	...
	public void playSimulation(int frame)
	{
				...
				// System.out.println(rcm1_x + "  " + rcm1_y + "  " +rcm1_z);
				...
				// System.out.println(rcm2_x + "  " + rcm2_y + "  " +rcm2_z);
				...
				//chain-jump over +Z
				 ...
				 //1.st chain
				 {
					...
					//Rg2_stat[frame-1].AddValue(Math.sqrt(Rg2));
				...
				// double Rc2c = (rcm2_x-rcm1_x)*(rcm2_x-rcm1_x) + (rcm2_y-rcm1_y)*(rcm2_y-rcm1_y) + (rcm2_z-rcm1_z)*(rcm2_z-rcm1_z);
				 ...
				 //Rc2c_stat[frame-1].AddValue(Math.sqrt(Rc2c));
				...
				// MetricsG_stat[frame-1].AddValue(MetricsG);
				 
				 //if(frame == 1)
				 //{
					// System.out.println(importData.MCSTime/(deltaT) + "   G: " + MetricsG + "  StatG:" + MetricsG_stat[(int) (importData.MCSTime/(deltaT))].ReturnM1());
				 //}
