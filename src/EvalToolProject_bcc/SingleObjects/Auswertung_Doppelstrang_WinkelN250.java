...
public class Auswertung_Doppelstrang_WinkelN250 {
	...
	public Auswertung_Doppelstrang_WinkelN250()
	{
		...
		//System.out.println("cf="+currentFrame);
		 ...
		 MonoProStrang=250;//250;
		 //String Name = "DoppelstrangA250_fest";
		 Name = "DoppelstrangA250MSD";
	...
	public static void main(String[] args) {
		...
		new Auswertung_Doppelstrang_WinkelN250();
	}
	...
	public void playSimulation(int frame)
	{
				...
				*/
				...
				//if(frame <= 20)
				{
				 savePunkte.DateiAnlegen("/home/users/dockhorn/MessungDiplom/octave/AusgewertetN250/"+Name+"_Punkte.dat",false);
					...
					savePunkte.setzeZeile("# rows: 250");
