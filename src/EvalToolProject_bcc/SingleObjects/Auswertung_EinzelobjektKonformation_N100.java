...
public class Auswertung_EinzelobjektKonformation_N100 {
	...
	public Auswertung_EinzelobjektKonformation_N100()
	{
		...
		//System.out.println("cf="+currentFrame);
		 ...
		 MonoProStrang=100;//250;
		 //String Name = "DoppelstrangA250_fest";
		 Name = "OneRing_N100_X512_Y128_Z128_fx_0.9";
...
/*		 Twist_StatElementKette1= new Statistik[24900];
		 	for (int i = 0; i < 24900; i++)
		 		Twist_StatElementKette1[i] = new Statistik();

		 Twist_StatElementKette2= new Statistik[24900];
		 	for (int i = 0; i < 24900; i++)
...
*/
		...
		FileDirectory = "/home/bondoki/Bachelor_Tom/octave/spline/1RingSpline/";
...
//		saveTwistElementKette1.DateiAnlegen("/home/users/dockhorn/MessungDiplom/octave/AusgewertetN250/"+Name+"_WindungElementKette1.dat",false);
//		saveTwistElementKette2.DateiAnlegen("/home/users/dockhorn/MessungDiplom/octave/AusgewertetN250/"+Name+"_WindungElementKette2.dat",false);
...
//	    saveTwistElementKette2.DateiSchliessen();
		    ...
		    while ( (z <= NrofFrames))
		      {
		    	...
		    	System.out.println("Frame: "+z+" von "+NrofFrames);
		    		playSimulation(z);
	...
	public static void main(String[] args) {
		...
		new Auswertung_EinzelobjektKonformation_N100();
	}
	...
	public void playSimulation(int frame)
	{
				...
				*/
				...
				//if(frame <= 20)
				{
				 savePunkte.DateiAnlegen("/home/bondoki/Bachelor_Tom/"+Name+"_Punkte.dat",false);
					...
					savePunkte.setzeZeile("# rows: 100");
					savePunkte.setzeZeile("# columns: 3");
					
					double dx = importData.PolymerKoordinaten[MonoProStrang][0]-importData.PolymerKoordinaten[1][0];
					double dy = importData.PolymerKoordinaten[MonoProStrang][1]-importData.PolymerKoordinaten[1][1];
					double dz = importData.PolymerKoordinaten[MonoProStrang][2]-importData.PolymerKoordinaten[1][2];
					double length = Math.sqrt(dx*dx+dy*dy+dz*dz);
					//Ring
					//savePunkte.setzeZeile(importData.PolymerKoordinaten[MonoProStrang][0]+ " "+ importData.PolymerKoordinaten[MonoProStrang][1] + " " +importData.PolymerKoordinaten[MonoProStrang][2]);
					//savePunkte.setzeZeile(dx+ " "+ dy + " " +dz);
					savePunkte.setzeZeile(dx/length+ " "+ dy/length + " " +dz/length);
		    		
					
					for(int i = 1; i <= MonoProStrang;i++)
		    				savePunkte.setzeZeile(importData.PolymerKoordinaten[i][0]+ " "+ importData.PolymerKoordinaten[i][1] + " " +importData.PolymerKoordinaten[i][2]);
		    		
					//Ring
					//savePunkte.setzeZeile(importData.PolymerKoordinaten[1][0]+ " "+ importData.PolymerKoordinaten[1][1] + " " +importData.PolymerKoordinaten[1][2]);
					//savePunkte.setzeZeile(-dx+ " "+ -dy + " " +-dz);
					savePunkte.setzeZeile(-dx/length+ " "+ -dy/length + " " +-dz/length);
					
					//for(int i = 1; i <= MonoProStrang;i++)
	    			//	savePunkte.setzeZeile(importData.PolymerKoordinaten[i][0]+ " "+ importData.PolymerKoordinaten[i][1] + " " +importData.PolymerKoordinaten[i][2] + " " + importData.PolymerKoordinaten[i+MonoProStrang][0]+ " "+ importData.PolymerKoordinaten[i+MonoProStrang][1] + " " +importData.PolymerKoordinaten[i+MonoProStrang][2]);
...
/*					 try {
					      Runtime.getRuntime().exec("octave /home/users/dockhorn/MessungDiplom/octave/AusgewertetN250/AuswertungTwistN250_Kette1.m").waitFor();
					     Thread.sleep(5);
					      Runtime.getRuntime().exec("octave /home/users/dockhorn/MessungDiplom/octave/AusgewertetN250/AuswertungTwistN250_Kette2.m").waitFor();
					      Thread.sleep(5);
					      //Runtime.getRuntime().
					 } catch (Exception e) {
					 ...
					 loader01.DateiOeffnen("/home/users/dockhorn/MessungDiplom/octave/AusgewertetN250/AuswertungTwistN250_StatKette1ElementTorsionKette1.dat");
					 ...
					 loader02.DateiOeffnen("/home/users/dockhorn/MessungDiplom/octave/AusgewertetN250/AuswertungTwistN250_StatKette1ElementTorsionKette2.dat");
