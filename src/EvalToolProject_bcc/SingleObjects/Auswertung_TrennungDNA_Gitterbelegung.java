...
public class Auswertung_TrennungDNA_Gitterbelegung {
...
//	Histogramm[] HG_Density_Time;
	...
	public Auswertung_TrennungDNA_Gitterbelegung(String fdir, String fname, String dirDst, int nrOfFiles)//, String skip, String current)
	{
...
//		Ordnungsgitter = new double[Gitter_x/maxBox_x][Gitter_y/maxBox_y][Gitter_z/maxBox_z];
	...
	public static void main(String[] args) {
		...
		else new Auswertung_TrennungDNA_Gitterbelegung(args[0], args[1], args[2] , Integer.parseInt(args[3]));//,args[1],args[2]);
