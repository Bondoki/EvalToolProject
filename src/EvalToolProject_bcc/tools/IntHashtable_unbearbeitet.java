...
public final class IntHashtable_unbearbeitet {
	
	public IntHashtable_unbearbeitet()
	{
          initialize(3);
    }

    public IntHashtable_unbearbeitet(int initialSize)
    {
          ...
          public int get(int key) {
           ...
           public boolean equals(Object that) {
                ...
                IntHashtable_unbearbeitet other = (IntHashtable_unbearbeitet) that;
           ...
           public Object clone() throws CloneNotSupportedException {
               IntHashtable_unbearbeitet result = (IntHashtable_unbearbeitet) super .clone();
