...
public class Auswertung_Sterne_Gyro_HepPEG_MSDStars {
	...
	public Auswertung_Sterne_Gyro_HepPEG_MSDStars(String fdir, String fname)//, String skip, String current)
	{
		...
		rg = new BFMFileSaver();
		rg.DateiAnlegen("/home/users/dockhorn/Simulationen/HEPPEGSolution/StarPEG_MSD_HepPEGSolution_"+FileName+".dat", false);
	...
	public static void main(String[] args) {
		...
		new Auswertung_Sterne_Gyro_HepPEG_MSDStars(args[0], args[1]);//,args[1],args[2]);
	}
