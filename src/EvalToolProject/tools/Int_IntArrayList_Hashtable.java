...
public final class Int_IntArrayList_Hashtable {
	
	public Int_IntArrayList_Hashtable()
	{
          initialize(3);
    }

    public Int_IntArrayList_Hashtable(int initialSize)
    {
          initialize(leastGreaterPrimeIndex((int) (initialSize / HIGH_WATER_FACTOR)));
           ...
           public int size() {
            ...
            public void put(int key, int value) {
                ...
                values[index].add(value); // reset value
                
                // zweite Zuordnung value->key 
                // zwecks Topologie aber entfernt zwecks Allgemeingueltigkeit
               /* index = find(value);
                if (keyList[index] <= MAX_UNUSED) { // deleted or empty
                   keyList[index] = value;
                    ++count;
                }
                values[index].add(key); // reset value
                */
          ...
          public IntArrayList get(int key) {
           ...
           public boolean equals(Object that) {
                ...
                Int_IntArrayList_Hashtable other = (Int_IntArrayList_Hashtable) that;
           ...
           /*public Object clone() throws CloneNotSupportedException {
               IntHashtable_j result = (IntHashtable_j) super .clone();
