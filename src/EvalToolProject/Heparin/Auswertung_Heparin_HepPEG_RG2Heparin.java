...
public class Auswertung_Heparin_HepPEG_RG2Heparin {
	...
	public Auswertung_Heparin_HepPEG_RG2Heparin(String fdir, String fname)//, String skip, String current)
	{
		...
		rg = new BFMFileSaver();
		rg.DateiAnlegen("/home/users/dockhorn/Simulationen/HEPPEGSolution/Heparin_Rg2_HepPEGSolution_"+FileName+".dat", true);
		rg.setzeZeile("# Rg2 for Heparin");
	...
	public static void main(String[] args) {
		...
		new Auswertung_Heparin_HepPEG_RG2Heparin(args[0], args[1]);//,args[1],args[2]);
	}
				 ...
				 for (int k= 1; k <= NrOfHeparin; k++)
				 {
					...
					Rg2 = Rg2_x + Rg2_y + Rg2_z;
					 ...
					 // Rg2_y /= 1.0*((4*NrOfMonomersPerStarArm + 1)*(4*NrOfMonomersPerStarArm + 1));
					  ...
					  Rg2 /= 1.0*90.0*90.0;//(4*NrOfMonomersPerStarArm + 1));
